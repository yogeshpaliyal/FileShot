package com.techpaliyal.FileShot.service;
...
import com.techpaliyal.FileShot.app.Service;
import com.techpaliyal.FileShot.config.AppConfig;
import com.techpaliyal.FileShot.config.Keyword;
import com.techpaliyal.FileShot.database.AccessDatabase;
import com.techpaliyal.FileShot.exception.AssigneeNotFoundException;
import com.techpaliyal.FileShot.exception.ConnectionNotFoundException;
import com.techpaliyal.FileShot.exception.DeviceNotFoundException;
import com.techpaliyal.FileShot.exception.TransferGroupNotFoundException;
import com.techpaliyal.FileShot.fragment.FileListFragment;
import com.techpaliyal.FileShot.object.NetworkDevice;
import com.techpaliyal.FileShot.object.TextStreamObject;
import com.techpaliyal.FileShot.object.TransferGroup;
import com.techpaliyal.FileShot.object.TransferInstance;
import com.techpaliyal.FileShot.object.TransferObject;
import com.techpaliyal.FileShot.util.AppUtils;
import com.techpaliyal.FileShot.util.CommunicationBridge;
import com.techpaliyal.FileShot.util.CommunicationNotificationHelper;
import com.techpaliyal.FileShot.util.DynamicNotification;
import com.techpaliyal.FileShot.util.FileUtils;
import com.techpaliyal.FileShot.util.HotspotUtils;
import com.techpaliyal.FileShot.util.NetworkDeviceLoader;
import com.techpaliyal.FileShot.util.NetworkUtils;
import com.techpaliyal.FileShot.util.NotificationUtils;
import com.techpaliyal.FileShot.util.NsdDiscovery;
import com.techpaliyal.FileShot.util.TimeUtils;
import com.techpaliyal.FileShot.util.TransferUtils;
import com.techpaliyal.FileShot.util.UpdateUtils;
...
public class CommunicationService extends Service
{
    ...
    public static final String ACTION_FILE_TRANSFER = "com.techpaliyal.FileShot.action.FILE_TRANSFER";
    public static final String ACTION_CLIPBOARD = "com.techpaliyal.FileShot.action.CLIPBOARD";
    public static final String ACTION_CANCEL_INDEXING = "com.techpaliyal.FileShot.action.CANCEL_INDEXING";
    public static final String ACTION_IP = "com.techpaliyal.FileShot.action.IP";
    public static final String ACTION_END_SESSION = "com.techpaliyal.FileShot.action.END_SESSION";
    public static final String ACTION_SEAMLESS_RECEIVE = "com.genonbeta.intent.action.SEAMLESS_START";
    public static final String ACTION_CANCEL_JOB = "com.techpaliyal.FileShot.transaction.action.CANCEL_JOB";
    public static final String ACTION_TOGGLE_SEAMLESS_MODE = "com.techpaliyal.FileShot.transaction.action.TOGGLE_SEAMLESS_MODE";
    public static final String ACTION_REVOKE_ACCESS_PIN = "com.techpaliyal.FileShot.transaction.action.REVOKE_ACCESS_PIN";
    public static final String ACTION_TOGGLE_HOTSPOT = "com.techpaliyal.FileShot.transaction.action.TOGGLE_HOTSPOT";
    public static final String ACTION_REQUEST_HOTSPOT_STATUS = "com.techpaliyal.FileShot.transaction.action.REQUEST_HOTSPOT_STATUS";
    public static final String ACTION_HOTSPOT_STATUS = "com.techpaliyal.FileShot.transaction.action.HOTSPOT_STATUS";
    public static final String ACTION_DEVICE_ACQUAINTANCE = "com.techpaliyal.FileShot.transaction.action.DEVICE_ACQUAINTANCE";
    public static final String ACTION_SERVICE_STATUS = "com.techpaliyal.FileShot.transaction.action.SERVICE_STATUS";
    public static final String ACTION_SERVICE_CONNECTION_TRANSFER_QUEUE = "com.techpaliyal.FileShot.transaction.action.SERVICE_CONNECTION_TRANSFER_QUEUE";
    public static final String ACTION_TASK_STATUS_CHANGE = "com.techpaliyal.FileShot.transaction.action.TASK_STATUS_CHANGE";
    public static final String ACTION_TASK_RUNNING_LIST_CHANGE = "com.techpaliyal.FileShot.transaction.action.TASK_RUNNNIG_LIST_CHANGE";
    public static final String ACTION_REQUEST_TASK_STATUS_CHANGE = "com.techpaliyal.FileShot.transaction.action.REQUEST_TASK_STATUS_CHANGE";
    public static final String ACTION_REQUEST_TASK_RUNNING_LIST_CHANGE = "com.techpaliyal.FileShot.transaction.action.REQUEST_TASK_RUNNING_LIST_CHANGE";
    public static final String ACTION_INCOMING_TRANSFER_READY = "com.techpaliyal.FileShot.transaction.action.INCOMING_TRANSFER_READY";
    public static final String ACTION_TRUSTZONE_STATUS = "com.techpaliyal.FileShot.transaction.action.TRUSTZONE_STATUS";
    public static final String ACTION_REQUEST_TRUSTZONE_STATUS = "com.techpaliyal.FileShot.transaction.action.REQUEST_TRUSTZONE_STATUS";
    public static final String ACTION_TOGGLE_WEBSHARE = "com.techpaliyal.FileShot.transaction.action.TOGGLE_WEBSHARE";
    public static final String ACTION_WEBSHARE_STATUS = "com.techpaliyal.FileShot.transaction.action.WEBSHARE_STATUS";
    public static final String ACTION_REQUEST_WEBSHARE_STATUS = "com.techpaliyal.FileShot.transaction.action.REQUEST_WEBSHARE_STATUS";
