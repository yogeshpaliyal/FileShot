...
import com.techpaliyal.FileShot.BuildConfig;
import com.techpaliyal.FileShot.App;
import com.techpaliyal.FileShot.R;
import com.techpaliyal.FileShot.activity.WebShareActivity;
...
public class AppUtils
{
    ...
    {
        try {
            return Keyword.Flavor.googlePlay;
        } catch (Exception e) {
            Log.e(TAG, "Current build flavor " + Keyword.Flavor.googlePlay + " is not specified in " +
