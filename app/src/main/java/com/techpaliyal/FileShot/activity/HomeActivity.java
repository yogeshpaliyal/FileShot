...
import com.techpaliyal.FileShot.dialog.ShareAppDialog;
import com.techpaliyal.FileShot.fragment.HomeFragment;
        ...
        implements NavigationView.OnNavigationItemSelectedListener, PowerfulActionModeSupport
{
    ...
    private void applyAwaitingDrawerAction()
    {
        if (mChosenMenuItemId == 0) {
            ...
            try {
                startActivity(new Intent(this, Class.forName("com.genonbeta.FileShot.activity.DonationActivity")));
